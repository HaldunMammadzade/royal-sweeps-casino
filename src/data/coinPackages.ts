...
export const dailyBonusPackages: CoinPackage[] = [
  {
    id: 'daily-small',
    name: 'Daily Boost',
    price: 4.99,
...
export const promotionPackages: CoinPackage[] = [
  {
    id: 'welcome',
...
export const vipPackages: CoinPackage[] = [
  {
    id: 'vip-gold',
    name: 'VIP Gold',
    price: 199.99,
...
export const getPackagesByType = (type: 'regular' | 'daily' | 'promotion' | 'vip'): CoinPackage[] => {
  switch (type) {
    case 'daily':
...
export const sortPackagesByValue = (packages: CoinPackage[]): CoinPackage[] => {
